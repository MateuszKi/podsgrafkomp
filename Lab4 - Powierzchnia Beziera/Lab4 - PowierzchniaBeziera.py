...
punktyStartowe_FILENAME = os.path.dirname(os.path.abspath(__file__)) + "\\" + "punktystartowe.txt"
punktyWyjsciowe_FILENAME = os.path.dirname(os.path.abspath(__file__)) + "\\" + "punktywyjsciowe.txt"
MATRIX_R = MATRIX_C = 4
...
punkty = powierzchniaBeziera(wczytajPunkty(punktyStartowe_FILENAME), 60)
write_to_file(kPunkty(punkty), punktyWyjsciowe_FILENAME)